export default function Position(){
    return(
        ...
        <div id="wd-css-position-fixed">
            ...
            Checkout the blue square that saysFixed positio stuck all the way on the right and half way down the page. It doesn't scroll with the rest of the page. Its position is "Fixed".
