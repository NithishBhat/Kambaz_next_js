export default function Position(){
    return(
        ...
        <div id="wd-css-position-fixed">
            ...
            Checkout the blue square that says Fixed position stuck all the way on the right and half way down the page. It doesnt scroll with the rest of the page. Its position isFixed.
